...
export default function Home() {
  return (
    <>
      ...
      >
        <div className="absolute -translate-y-[11vh] max-sm:-translate-y-[9.6vh] max-lg:-translate-y-[7vh] max-[1025px]:-translate-y-[6vh] flex flex-col justify-center items-center">
