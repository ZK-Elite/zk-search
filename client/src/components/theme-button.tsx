                    ...
                    isClient && (
                        <button className="cursor-pointer" onClick={() => theme === "dark" ? setTheme("light") : setTheme("dark")}>
                            <div className="relative flex items-center border-gray-500 border-2 rounded-full">
                                ...
                                <div className={`z-10 flex justify-center items-center ease-in-out w-7 h-7 absolute rounded-full right-0 transform bg-white  ${theme === "light" ? "-translate-x-9" : "translate-x-0"}`}></div>
                            </div>
                        </button>
                    )
                }
