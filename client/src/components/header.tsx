  ...
  return (
    ...
    >
      <div className="flex w-full md:px-4 pt-6 pb-4 items-end">
        ...
        <div
          className={`ml-auto sm:flex hidden cursor-pointer bg-opacity-70 ${pathname === "/" && "mt-3.5"}`}
        >
          <ThemeButton />
        </div>
      </div>
      ...
      <div
        className={`${pathname === "/search" && "mx-4 border-b border-[#27272A] sm:flex hidden"}`}
      >
      </div>
    </div>
  );
