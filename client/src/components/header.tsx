...
const Header = () => {
  ...
  return (
    ...
    >
      <div className="flex w-full   md:px-4 py-2 items-end">
        {pathname === "/search" && (
        ...
        <div
          className={`ml-auto sm:flex hidden cursor-pointer bg-opacity-70 ${
            pathname === "/" && "mt-3.5"
          }`}
        >
          <ThemeButton />
      ...
      {pathname === "/search" && (
        <div className="flex flex-row mt-2  sm:gap-5 sm:justify-start justify-between sm:ml-[72px]">
